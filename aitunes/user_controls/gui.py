...
class MainView(ctk.CTkFrame):
    ...
    def _create_action_buttons(self):
        ...
        def display_perf_command():
            self._run_closed(lambda: self.actions.instantiate_experiment().display_latent_performance())
        ...
        self.btn_perf = ctk.CTkButton(self.btn_frame, text="Performance", height=35, command=display_perf_command)
        self.btn_perf.pack(side=ctk.RIGHT, pady=10)
