...
def main():
    dossier_audio = "tests/test_samples/audio"  # Dossier contenant les fichiers audio
    output_folder = "tests/output/processed_spectrograms"  # Dossier pour sauvegarder les spectrogrammes
